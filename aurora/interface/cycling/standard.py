...
from ...query import query_available_protocols, update_available_protocols
...
class CyclingStandard(ipw.VBox):
    ...
    def __init__(self, validate_callback_f):
        ...
        self.w_protocol_preview = ipw.Output(layout=self.OUTPUT_LAYOUT)
        self.w_protocol_parameters = ipw.Label("[...additional parameters...]")

        self.w_validate = ipw.Button(
            description="Submit",
            button_style='success',
            tooltip="Submit the selected test",
            icon='play',
        ...
        self.w_protocol_select.observe(self.on_protocol_value_change,
                                       names='value')
